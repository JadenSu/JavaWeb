          ...
          <div class="form-group">
            <label for="address">籍贯：</label>
             <select name="address" id="address" class="form-control" >
                 <c:if test="${user.address == '燕山'}">
                    <option value="燕山" selected>燕山</option>
                    <option value="常山">常山</option>
                    <option value="三国">三国</option>
                 </c:if>

                 <c:if test="${user.address == '常山'}">
                     <option value="燕山" >燕山</option>
                     <option value="常山" selected>常山</option>
                     <option value="三国">三国</option>
                 </c:if>

                 <c:if test="${user.address == '三国'}">
                     <option value="燕山" >燕山</option>
                     <option value="常山">常山</option>
                     <option value="三国" selected>三国</option>
                 </c:if>
            </select>
          </div>
